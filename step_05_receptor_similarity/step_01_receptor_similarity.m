...
% <Connectome of neurotransmitter receptor and transporter expression is associated with FC variability gradient across edges>
% The similarity between fc variability and receptor similarity were measured by spearman's rank correlation.
...
working_dir = [root_dir 'step_05_receptor_similarity/'];
...
% HCP-D
load([mat_dir 'receptor_similarity.mat'],'receptor_similarity')
