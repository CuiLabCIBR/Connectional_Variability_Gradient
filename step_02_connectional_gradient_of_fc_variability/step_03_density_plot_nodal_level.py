...
def density_show(input_file,x_label,y_label,out_path):
    ...
    ax.set_xticks(np.arange(0 , 0.71, interval), fontsize=fontsize, fontname='Arial')
...
if __name__ == '__main__':
    file_path = 'F:/Cui_Lab/Projects/Connectional_Variability_Gradient/step_02_connectional_gradient_of_fc_variability'
