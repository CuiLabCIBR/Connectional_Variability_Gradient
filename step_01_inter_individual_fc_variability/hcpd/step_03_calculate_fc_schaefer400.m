...
working_dir = '/GPFS/cuizaixu_lab_permanent/yanghang/projects/p01_connectional_variability_gradient/hcpd';
bold_dir = [working_dir '/bold_signal/'];

load('/GPFS/cuizaixu_lab_permanent/yanghang/projects/p01_connectional_variability_gradient/functions/hcpd_sublist.mat')
...
save('F:/Cui_Lab/Projects/Connectional_Variability_Gradient/data/connectome_matrix/schaefer400/fc_hcpd.mat','fc_mat');
