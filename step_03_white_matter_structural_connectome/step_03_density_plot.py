...
def density_show(input_file,x_label,y_label,out_path):
    ...
    ax.set_xticks(np.arange(-7, -0.1, 2))
...
if __name__ == '__main__':
    file_path = 'F:/Cui_Lab/Projects/Connectional_Variability_Gradient/step_03_white_matter_structural_connectome'
