% ---------------------------------------------------------------------------------------------------------------
% This script was used to generate HCP-D results of Figure 6
...
load([working_dir,'hcpd_cognitive_info.mat'])
...
for i = 1
    ...
    writetable(tbl,[working_dir 'gam_cog_hcpd_' gradient_label{i} '.csv'])
end