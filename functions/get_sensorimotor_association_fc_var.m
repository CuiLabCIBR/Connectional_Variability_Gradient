...
% VS_SM = reshape(data_reorder(lines(1):lines(2)-1,lines(2):lines(3)-1),1,sum(net_label == 1) * sum(net_label == 2));
% S_S = [VS,SM,VS_SM];

S_S = mat2vec(data_reorder(lines(1):lines(3)-1,lines(1):lines(3)-1));
